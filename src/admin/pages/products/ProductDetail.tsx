            ...
            >
              ...
              >
                ...
                <Card className="mt-4 shadow-sm">
                  ...
                  {product.description ? (
                    <div
                      className="product-description dark:text-gray-300"
                    ...
                    renderItem={(image: ProductImageResponse) => (
                      <List.Item>
                        <Card
                          ...
                          className={
                            image.isPrimary ? "border-2 border-primary" : ""
                          }
                        >
              ...
              >
                <div className="p-4 bg-white rounded-lg text-center">
                  ...
                  <Button
                    ...
                    className="mt-4"
                    onClick={() =>
                      window.open(product.qrCode?.redirectUrl, "_blank")
                    }
                  >
