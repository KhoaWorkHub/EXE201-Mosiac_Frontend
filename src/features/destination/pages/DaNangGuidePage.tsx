...
const attractionsData = [
  {
    ...
    rating: 4.8,
    description:
      "The world-famous Golden Bridge held up by giant stone hands, offering breathtaking panoramic views of the Da Nang mountains and coastline.",
    descriptionVi:
      "Cây cầu Vàng nổi tiếng thế giới được nâng đỡ bởi những bàn tay đá khổng lồ, mang đến tầm nhìn toàn cảnh ngoạn mục về núi non và bờ biển Đà Nẵng.",
  },
  {
    id: 2,
    ...
    rating: 4.6,
    description:
      "A sacred cluster of five marble and limestone hills with mystical caves, ancient temples, and Buddhist sanctuaries.",
    descriptionVi:
      "Một quần thể thiêng liêng gồm năm ngọn núi đá cẩm thạch và đá vôi với hang động huyền bí, đền cổ và các thánh địa Phật giáo.",
  },
  {
    id: 3,
    name: "My Khe Beach",
    ...
    rating: 4.7,
    description:
      "One of the world's most beautiful beaches with pristine white sand, crystal-clear waters, and perfect waves for surfing.",
    descriptionVi:
      "Một trong những bãi biển đẹp nhất thế giới với cát trắng tinh khiết, làn nước trong như pha lê và sóng hoàn hảo để lướt sóng.",
  },
  {
    id: 4,
    name: "Dragon Bridge",
    ...
    rating: 4.5,
    description:
      "An architectural marvel shaped like a golden dragon that breathes fire and water every weekend, symbolizing Da Nang's power and prosperity.",
    descriptionVi:
      "Một kỳ quan kiến trúc có hình dạng con rồng vàng phun lửa và nước mỗi cuối tuần, tượng trưng cho sức mạnh và sự thịnh vượng của Đà Nẵng.",
  },
  {
    id: 5,
    ...
    rating: 4.6,
    description:
      "A pristine natural reserve featuring the majestic Lady Buddha statue, endangered red-shanked douc langurs, and untouched beaches.",
    descriptionVi:
      "Khu bảo tồn thiên nhiên hoang sơ với tượng Phật Bà uy nghi, loài voọc chà vá chân nâu quý hiếm và những bãi biển hoang sơ.",
  },
  {
    id: 6,
    name: "Hai Van Pass",
    ...
    rating: 4.9,
    description:
      'The legendary "Sea Cloud Pass" offering the most spectacular coastal mountain views in Vietnam, featured in Top Gear as one of the world\'s most beautiful roads.',
    descriptionVi:
      'Đèo "Hải Vân" huyền thoại mang đến cảnh quan núi biển ngoạn mục nhất Việt Nam, được giới thiệu trong Top Gear như một trong những con đường đẹp nhất thế giới.',
  },
];
...
useEffect(() => {
  ...
  const prevImage = () => {
    setCurrentImageIndex(
      (prev) => (prev - 1 + daNangImages.length) % daNangImages.length
    );
  };
  ...
  const getCurrentImage = () => {
    const validImages = daNangImages.filter(
              ...
              <motion.div
                ...
                className={`absolute bg-gradient-to-t ${
                  i === 0
                    ...
                    : i === 2
                    ? "from-yellow-400/25 to-transparent"
                    : i === 3
                    ? "from-amber-500/20 to-transparent"
                    : i === 4
                    ? "from-orange-500/15 to-transparent"
                    : i === 5
                    ? "from-yellow-500/12 to-transparent"
  ...
  return (
    <MainLayout>
      {/* Tour Guide */}
      <AnimatePresence>
        {showTourGuide && <TourGuideSteps onClose={closeTourGuide} />}
      </AnimatePresence>
          ...
          {Array.from({ length: 8 }).map((_, i) => (
            <motion.div
              ...
              className={`absolute bottom-0 ${
                i === 0
                  ? "w-40 h-64 bg-gradient-to-t from-amber-800/70 to-transparent"
                  : i === 1
                  ? "w-36 h-72 bg-gradient-to-t from-orange-800/60 to-transparent"
                  : i === 2
                  ? "w-44 h-56 bg-gradient-to-t from-yellow-800/50 to-transparent"
                  : i === 3
                  ? "w-32 h-68 bg-gradient-to-t from-amber-700/40 to-transparent"
                  : i === 4
                  ? "w-48 h-52 bg-gradient-to-t from-orange-700/35 to-transparent"
                  : i === 5
                  ? "w-28 h-76 bg-gradient-to-t from-yellow-700/30 to-transparent"
                  : i === 6
                  ? "w-52 h-48 bg-gradient-to-t from-amber-600/25 to-transparent"
                  : "w-24 h-80 bg-gradient-to-t from-orange-600/20 to-transparent"
              }`}
              style={{
                left: i * 12 + 3 + "%",
                clipPath: `polygon(${10 + i * 5}% 0%, ${
                  90 - i * 5
                }% 0%, 95% 100%, 5% 100%)`,
        ...
        <div className="absolute top-1/2 left-6 transform -translate-y-1/2 z-20">
          <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
            <Button
              ...
              icon={<LeftOutlined />}
              onClick={prevImage}
              className="bg-white/90 border-white/30 hover:bg-white text-gray-800 hover:text-gray-900 shadow-lg backdrop-blur-sm transition-all duration-300"
              size="large"
            />
          </motion.div>
        </div>
      ...
      <section className="py-8 md:py-16 bg-gradient-to-br from-white via-amber-50/30 to-orange-50/20 dark:from-gray-800 dark:via-amber-900/10 dark:to-orange-900/10 relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-5">
          <svg viewBox="0 0 1200 120" className="w-full h-full">
            ...
            />
            <path
              d="M0,80 C150,50 350,110 600,80 C850,50 1050,110 1200,80 L1200,120 L0,120 Z"
              fill="currentColor"
              ...
              >
                <motion.div variants={itemVariants} className="mb-6 md:mb-8">
                  <div className="flex flex-col md:flex-row md:items-center mb-4">
                    <Title
                      level={2}
                      className="mb-2 md:mb-0 dark:text-white bg-gradient-to-r from-amber-700 via-orange-700 to-yellow-800 bg-clip-text text-transparent text-xl md:text-2xl lg:text-3xl"
                    >
                      {t("overview.title")}
                    </Title>
                    <Tag
            ...
            >
              ...
              >
                <motion.div variants={itemVariants} className="mb-6 md:mb-8">
                  <Title
                    level={2}
                    className="mb-4 dark:text-white bg-gradient-to-r from-amber-700 via-orange-700 to-yellow-800 bg-clip-text text-transparent text-xl md:text-2xl lg:text-3xl"
                  >
                    {t("attractions.title")}
                  </Title>
                  <Paragraph className="text-base md:text-lg dark:text-gray-300">
                      ...
                      <Card className="danang-gradient-card h-full">
                        <div className="flex flex-col md:flex-row md:items-start">
                          ...
                          <div className="text-center md:text-left flex-grow">
                            <Title
                              level={5}
                              className="mb-1 dark:text-white text-amber-700 text-base md:text-lg"
                            >
                  ...
                  {Array.from({ length: 4 }).map((_, index) => (
                    ...
                    >
                      <Card className="h-full danang-gradient-card">
                        <Title
                          level={4}
                          className="mb-2 dark:text-white text-amber-700 text-base md:text-lg"
                        >
      ...
      <section
        ref={galleryRef}
        className="py-8 md:py-16 bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-100 dark:from-amber-900/20 dark:via-orange-900/20 dark:to-yellow-900/20 relative overflow-hidden"
      >
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-6 md:mb-8">
            <Title
              level={2}
              className="mb-3 dark:text-white bg-gradient-to-r from-amber-700 via-orange-700 to-yellow-800 bg-clip-text text-transparent text-xl md:text-2xl lg:text-3xl"
            >
