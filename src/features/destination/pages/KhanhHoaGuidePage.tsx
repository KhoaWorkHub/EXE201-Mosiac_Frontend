...
const attractionsData = [
  {
    ...
    duration: 'Full day',
    rating: 4.8,
    description: 'One of Vietnam\'s most beautiful beaches with crystal clear turquoise waters, white sand, and perfect conditions for swimming and water sports.',
    descriptionVi: 'Một trong những bãi biển đẹp nhất Việt Nam với làn nước trong xanh như ngọc, cát trắng mịn và điều kiện hoàn hảo cho bơi lội và thể thao dưới nước.',
  },
  {
    id: 2,
    name: 'Vinpearl Land',
    ...
    duration: '6-8 hours',
    rating: 4.7,
    description: 'A world-class entertainment complex accessible by the world\'s longest sea-crossing cable car, featuring theme parks, water parks, and luxury resorts.',
    descriptionVi: 'Khu phức hợp giải trí đẳng cấp thế giới với cáp treo vượt biển dài nhất thế giới, bao gồm công viên chủ đề, công viên nước và resort cao cấp.',
  },
  {
    id: 3,
    ...
    duration: '1-2 hours',
    rating: 4.5,
    description: 'Ancient Cham temple complex built between 7th-12th centuries, dedicated to Po Nagar goddess, offering insights into Cham culture and stunning city views.',
    descriptionVi: 'Quần thể đền Chăm cổ được xây dựng từ thế kỷ 7-12, thờ nữ thần Po Nagar, mang đến cái nhìn sâu sắc về văn hóa Chăm và tầm nhìn tuyệt đẹp ra thành phố.',
  },
  {
    id: 4,
    ...
    duration: '3-4 hours',
    rating: 4.6,
    description: 'Unique therapeutic mud bathing experience with mineral-rich mud from local hot springs, offering relaxation and skin benefits in a beautiful natural setting.',
    descriptionVi: 'Trải nghiệm tắm bùn trị liệu độc đáo với bùn giàu khoáng chất từ suối nước nóng địa phương, mang lại sự thư giãn và lợi ích cho da trong khung cảnh thiên nhiên tuyệt đẹp.',
  },
  {
    id: 5,
    ...
    duration: 'Full day',
    rating: 4.7,
    description: 'Explore the pristine islands of Nha Trang Bay including Hon Mun, Hon Tam, and Hon Mieu, perfect for snorkeling, diving, and beach relaxation.',
    descriptionVi: 'Khám phá các hòn đảo hoang sơ của vịnh Nha Trang bao gồm Hòn Mun, Hòn Tằm và Hòn Miễu, hoàn hảo cho lặn với ống thở, lặn biển và thư giãn trên bãi biển.',
  },
  {
    id: 6,
    ...
    duration: '4-5 hours',
    rating: 4.4,
    description: 'A spectacular eco-tourism site featuring multi-tiered waterfalls, crocodile farm, elephant rides, and lush tropical forest perfect for nature lovers.',
    descriptionVi: 'Điểm du lịch sinh thái nspectacular với thác nước nhiều tầng, trại cá sấu, cưỡi voi và rừng nhiệt đới tươi tốt hoàn hảo cho những người yêu thiên nhiên.',
  },
];
...
const KhanhHoaGuidePage: React.FC = () => {
  ...
  return (
    <MainLayout>
      ...
      <AnimatePresence>
        {showTourGuide && (
          <KhanhHoaTourGuideSteps onClose={closeTourGuide} />
        )}
      </AnimatePresence>
          ...
          {Array.from({ length: 4 }).map((_, i) => (
            <motion.div
              ...
              className={`absolute bottom-0 w-[200%] h-32 ${
                i === 0 ? 'bg-gradient-to-r from-blue-500/40 to-cyan-500/40' :
                i === 1 ? 'bg-gradient-to-r from-cyan-500/30 to-teal-500/30' :
                i === 2 ? 'bg-gradient-to-r from-teal-500/20 to-blue-500/20' :
                'bg-gradient-to-r from-blue-400/10 to-cyan-400/10'
              }`}
              style={{
                clipPath: `polygon(0 ${40 + i * 10}%, 100% ${60 + i * 5}%, 100% 100%, 0 100%)`,
      ...
      <section className="py-8 md:py-16 bg-white dark:bg-gray-800 relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-5">
          <svg viewBox="0 0 1200 120" className="w-full h-full">
            <path d="M0,60 C200,20 400,100 600,60 C800,20 1000,100 1200,60 L1200,120 L0,120 Z" fill="currentColor" className="text-blue-500"/>
          </svg>
        </div>
          ...
          {Array.from({ length: 3 }).map((_, i) => (
            <motion.div
              ...
              className={`absolute w-full h-full opacity-10 ${
                ...
                i === 1 ? 'bg-gradient-to-r from-cyan-400 to-teal-400' :
