...
const ProductsPage: React.FC = () => {
  ...
  const { products, loading, pagination, filters } = useAppSelector(
        ...
        <div className="mb-6">
          <RegionQuickFilter
            ...
            onRegionChange={(regionId: any) =>
              quickApplyFilter("regionId", regionId)
            }
            showTitle={true}
            cardSize="medium"
            columns={5}
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
                ...
                <div className="mb-6">
                  ...
                  <RegionListFilter
                    ...
                    // eslint-disable-next-line @typescript-eslint/no-explicit-any
                    onRegionChange={(regionId: any) =>
                      handleFilterChange("regionId", regionId)
                    }
                    showAllOption={true}
                  />
                </div>
                      ...
                      description={
                        <div className="text-center">
                          <div className="text-lg mb-2 dark:text-white">
                            {getCurrentRegion()
                              ? t("product:no_products_in_region", {
                                  region: getCurrentRegion()!.name,
                                })
                          ...
                          {getActiveFiltersCount() > 0 && (
                            <Space>
                              ...
                              {getCurrentRegion() && (
                                <Button
                                  onClick={() =>
                                    quickApplyFilter("regionId", undefined)
                                  }
                                >
                ...
                >
                  <Pagination
                    ...
                    showTotal={(total, range) =>
                      `${range[0]}-${range[1]} ${t("product:of")} ${total} ${t(
                        "product:products"
                      )}`
                    }
                    size="default"
